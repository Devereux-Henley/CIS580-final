 ...
 */
function Spear(point,direction) {
  this.spritesheet  = new Image();
  this.spritesheet.src = encodeURI('assets/spear.png');
  this.points = [{
    x: position.x,
    y: position.y
  },
...
Spear.prototype.onCollision = function(entity)
{
  switch(entity.tag)
  {
    case "pillar":
 ...
 */
Spear.prototype.update = function(time)
{
 ...
 */
Spear.prototype.render = function(time, ctx) {
  ctx.save();
